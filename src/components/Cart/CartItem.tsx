      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-4 mb-3 text-sm text-luxury-gray-600">
            {item.size && (
              <span>Taille: <span className="font-medium text-luxury-black">{item.size}</span></span>
            )}
            {item.color && (
              <span>Couleur: <span className="font-medium text-luxury-black">{item.color}</span></span>
            )}
          </div>
