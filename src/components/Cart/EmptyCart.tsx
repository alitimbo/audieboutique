  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto">
        ...
        >
          Découvrez nos dernières nouveautés et laissez-vous séduire par notre sélection exclusive de mode féminine.
        </motion.p>
        ...
        >
          <h3 className="font-semibold text-luxury-black mb-3">Suggestions pour vous :</h3>
          <div className="flex flex-wrap justify-center gap-2">
            {['Lingerie', 'Wax', 'Bijoux', 'Corsets', 'Maillots'].map((category) => (
              <Link
                key={category}
