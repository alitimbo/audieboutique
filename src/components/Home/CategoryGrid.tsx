...
import { Percent, Sparkles, Users, Shirt, Heart, Waves, ShoppingBag, Gem, FolderHeart as UserHeart } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-luxury-gray-300 max-w-2xl mx-auto">
            Découvrez notre sélection soigneusement choisie pour sublimer votre style
          </p>
        </motion.div>
            ...
            >
              <Link to={category.link}>
                <div className="relative bg-luxury-black rounded-3xl p-8 border border-luxury-gray-800 hover:border-luxury-red transition-all duration-300 shadow-luxury overflow-hidden">
                  ...
                  {/* Hover Effect */}
                  <motion.div
                    className="absolute bottom-0 left-0 right-0 h-1 bg-luxury-red transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"
                  />
                </div>
              </Link>
            </motion.div>
