            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full'>
              ...
              >
                ...
                <p className='text-xl text-luxury-gray-300 max-w-2xl mx-auto'>
                  Notre équipe est à votre écoute pour vous accompagner dans
                  votre expérience Audie Boutique
                </p>
              </motion.div>
            </div>
          </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='flex items-start space-x-4'>
                    ...
                    <div>
                      ...
                      <p className='text-luxury-gray-600'>0696 01 01 11</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='bg-luxury-gray-50 p-4 rounded-xl'>
                    ...
                    <p className='text-luxury-gray-600 text-sm'>
                      Nous nous engageons à répondre à vos messages dans les 24h
                      ouvrées. Pour les demandes urgentes, n'hésitez pas à nous
                      appeler.
                    </p>
                  </div>
                </div>
