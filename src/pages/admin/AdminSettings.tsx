...
export const AdminSettings: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      default:
        return <div className="text-center py-8 text-gray-500">Section en cours de développement</div>;
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Configurez votre boutique et vos préférences</p>
      </div>
